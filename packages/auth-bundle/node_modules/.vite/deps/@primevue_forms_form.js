...
// ../../node_modules/.pnpm/@primevue+forms@4.5.4_vue@3.5.30_typescript@5.9.3_/node_modules/@primevue/forms/useform/index.mjs
function _typeof(o) {
    ...
    return _regeneratorDefine2(u2, "_invoke", (function(r3, n3, o3) {
      ...
      function d(r4, n4) {
        for (c3 = r4, u3 = n4, t = 0; !y && f2 && !o4 && t < p.length; t++) {
          var o4, i4 = p[t], d2 = G.p, l2 = i4[2];
          r4 > 3 ? (o4 = l2 === n4) && (u3 = i4[(c3 = i4[4]) ? 5 : (c3 = 3, 3)], i4[4] = i4[5] = e) : i4[0] <= d2 && ((o4 = r4 < 2 && d2 < i4[1]) ? (c3 = 0, G.v = n4, G.n = i4[1]) : d2 < l2 && (o4 = r4 < 3 || i4[0] > n4 || n4 > l2) && (i4[4] = r4, i4[5] = n4, G.n = l2, c3 = 0));
        }
        if (o4 || r4 > 1) return a;
        throw y = true, n4;
      }
      return function(o4, p2, l2) {
        if (f2 > 1) throw TypeError("Generator is already running");
        for (y && 1 === p2 && d(p2, l2), c3 = p2, u3 = l2; (t = c3 < 2 ? e : u3) || !y; ) {
...
var useForm = function useForm2() {
  ...
  var isFieldValidate = function isFieldValidate2(field, validateOn2) {
    var value = m(validateOn2, field);
    return value === true || C(value) && value.includes(field);
  };
  var validateOn = (function() {
    var _ref3 = _asyncToGenerator(_regenerator().m(function _callee(option, defaultValue) {
      var _options$option;
  ...
  var handleSubmit = function handleSubmit2(callback) {
    return (function() {
      var _ref4 = _asyncToGenerator(_regenerator().m(function _callee2(event) {
        var results;
  ...
  var handleReset = function handleReset2(callback) {
    return (function() {
      var _ref5 = _asyncToGenerator(_regenerator().m(function _callee3(event) {
  ...
  var validate = (function() {
    var _ref6 = _asyncToGenerator(_regenerator().m(function _callee4(field) {
      ...
      return _regenerator().w(function(_context4) {
        while (1) switch (_context4.n) {
          ...
          case 9:
            fieldResult = _t8;
            C(fieldResult.errors) && (fieldResult.errors = _defineProperty({}, fieldName, fieldResult.errors));
  ...
  var reset = function reset2() {
    Object.keys(_states).forEach((function() {
      var _ref0 = _asyncToGenerator(_regenerator().m(function _callee5(field) {
        var _fields$field3;
        var watcher;
...
// ../../node_modules/.pnpm/@primevue+forms@4.5.4_vue@3.5.30_typescript@5.9.3_/node_modules/@primevue/forms/form/style/index.mjs
var classes = {
...
// ../../node_modules/.pnpm/@primevue+forms@4.5.4_vue@3.5.30_typescript@5.9.3_/node_modules/@primevue/forms/form/index.mjs
var script$1 = {
  name: "BaseForm",
  "extends": script,
  style: FormStyle,
