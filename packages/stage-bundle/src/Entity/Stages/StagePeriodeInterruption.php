...
use StageBundle\Repository\Stages\StagePeriodeInterruptionRepository;
...
class StagePeriodeInterruption
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(targetEntity: StagePeriode::class, inversedBy: 'periodesInterruption')]
