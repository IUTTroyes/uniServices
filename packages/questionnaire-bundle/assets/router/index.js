...
import qualiteRoutes from './modules/questionnaireAdministrationRoutes.js';
...
const intranetMenu = [
    {
        items: [
            ...
            { label: 'Qualité', icon: 'pi pi-fw pi-home', to: '/qualite' },
        ]
    }
];
...
const router = createRouter({
    history: createWebHistory('/questionnaire/'),
    routes: [
        {
            path: '/',
...
router.beforeEach(async (to, from) => {
    document.title = to.meta.title ? (to.meta.title + ' | Questionnaires - Uniservices ') : 'Questionnaires - Uniservices';
