...
export default defineConfig(({ mode }) => {
  ...
  process.env.VITE_API_URL =
    env.VITE_API_URL || env.VITE_BASE_URL || "https://localhost:8000";
  ...
  return {
    ...
    base: "/questionnaire/",
    build: {
      outDir: path.resolve(__dirname, "../../back/public/questionnaire"),
      emptyOutDir: true,
    },
    server: {
      proxy: {
    ...
    resolve: {
      alias: {
        ...
        "@dialogs": path.resolve(__dirname, "../../shared/dialogs"),
