...
var w3 = (e = {}) => {
  ...
  return { preset(s4) {
    ...
    let a2 = { preset: s4 ? H2(S2.getPreset(), t2) : t2, options: i2 ? h2(h2({}, S2.getOptions()), r) : r };
...
var b3 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  var R2, T2, j2, O2, M3, z3, V2;
  let { preset: a2, options: n } = t2, l2, o, c3, m2, d2, u, g3;
  if (s2(a2) && n.transform !== "strict") {
    let { primitive: L, semantic: te, extend: re2 } = a2, f2 = te || {}, { colorScheme: K3 } = f2, A2 = v2(f2, ["colorScheme"]), x3 = re2 || {}, { colorScheme: X2 } = x3, G2 = v2(x3, ["colorScheme"]), p2 = K3 || {}, { dark: U2 } = p2, B = v2(p2, ["dark"]), y3 = X2 || {}, { dark: I2 } = y3, H3 = v2(y3, ["dark"]), W3 = s2(L) ? this._toVariables({ primitive: L }, n) : {}, q3 = s2(A2) ? this._toVariables({ semantic: A2 }, n) : {}, Z = s2(B) ? this._toVariables({ light: B }, n) : {}, pe = s2(U2) ? this._toVariables({ dark: U2 }, n) : {}, fe = s2(G2) ? this._toVariables({ semantic: G2 }, n) : {}, ye = s2(H3) ? this._toVariables({ light: H3 }, n) : {}, Se = s2(I2) ? this._toVariables({ dark: I2 }, n) : {}, [Me, ze] = [(R2 = W3.declarations) != null ? R2 : "", W3.tokens], [Ke, Xe] = [(T2 = q3.declarations) != null ? T2 : "", q3.tokens || []], [Ge, Ue] = [(j2 = Z.declarations) != null ? j2 : "", Z.tokens || []], [Be, Ie] = [(O2 = pe.declarations) != null ? O2 : "", pe.tokens || []], [He, We] = [(M3 = fe.declarations) != null ? M3 : "", fe.tokens || []], [qe, Ze] = [(z3 = ye.declarations) != null ? z3 : "", ye.tokens || []], [Fe, Je] = [(V2 = Se.declarations) != null ? V2 : "", Se.tokens || []];
  ...
  if (s2(t2) && r.transform !== "strict") {
    let y3 = e.replace("-directive", ""), m2 = t2, { colorScheme: R2, extend: T2, css: j2 } = m2, O2 = v2(m2, ["colorScheme", "extend", "css"]), d2 = T2 || {}, { colorScheme: M3 } = d2, z3 = v2(d2, ["colorScheme"]), u = R2 || {}, { dark: V2 } = u, L = v2(u, ["dark"]), g3 = M3 || {}, { dark: te } = g3, re2 = v2(g3, ["dark"]), K3 = s2(O2) ? this._toVariables({ [y3]: h2(h2({}, O2), z3) }, r) : {}, A2 = s2(L) ? this._toVariables({ [y3]: h2(h2({}, L), re2) }, r) : {}, X2 = s2(V2) ? this._toVariables({ [y3]: h2(h2({}, V2), te) }, r) : {}, [G2, U2] = [(f2 = K3.declarations) != null ? f2 : "", K3.tokens || []], [B, I2] = [(x3 = A2.declarations) != null ? x3 : "", A2.tokens || []], [H3, W3] = [(p2 = X2.declarations) != null ? p2 : "", X2.tokens || []], q3 = this.transformCSS(y3, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y3, H3, "dark", "variable", r, i2, a2, n);
...
//# sourceMappingURL=chunk-FC3KBYYP.js.map
