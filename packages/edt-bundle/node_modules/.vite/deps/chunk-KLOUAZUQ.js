...
var b3 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s2(t2) && r.transform !== "strict") {
    let y3 = e.replace("-directive", ""), m2 = t2, { colorScheme: R2, extend: T2, css: j2 } = m2, O = v2(m2, ["colorScheme", "extend", "css"]), d2 = T2 || {}, { colorScheme: M3 } = d2, z3 = v2(d2, ["colorScheme"]), u = R2 || {}, { dark: V2 } = u, L = v2(u, ["dark"]), g3 = M3 || {}, { dark: te } = g3, re2 = v2(g3, ["dark"]), K3 = s2(O) ? this._toVariables({ [y3]: h2(h2({}, O), z3) }, r) : {}, A2 = s2(L) ? this._toVariables({ [y3]: h2(h2({}, L), re2) }, r) : {}, X2 = s2(V2) ? this._toVariables({ [y3]: h2(h2({}, V2), te) }, r) : {}, [G2, U2] = [(f2 = K3.declarations) != null ? f2 : "", K3.tokens || []], [B, I2] = [(x3 = A2.declarations) != null ? x3 : "", A2.tokens || []], [H3, W2] = [(p2 = X2.declarations) != null ? p2 : "", X2.tokens || []], q2 = this.transformCSS(y3, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y3, H3, "dark", "variable", r, i2, a2, n);
...
//# sourceMappingURL=chunk-KLOUAZUQ.js.map
