...
var b2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s(t2) && r.transform !== "strict") {
    let y2 = e.replace("-directive", ""), m2 = t2, { colorScheme: R2, extend: T2, css: j2 } = m2, O = v2(m2, ["colorScheme", "extend", "css"]), d = T2 || {}, { colorScheme: M2 } = d, z3 = v2(d, ["colorScheme"]), u = R2 || {}, { dark: V2 } = u, L = v2(u, ["dark"]), g2 = M2 || {}, { dark: te } = g2, re2 = v2(g2, ["dark"]), K2 = s(O) ? this._toVariables({ [y2]: h2(h2({}, O), z3) }, r) : {}, A2 = s(L) ? this._toVariables({ [y2]: h2(h2({}, L), re2) }, r) : {}, X = s(V2) ? this._toVariables({ [y2]: h2(h2({}, V2), te) }, r) : {}, [G3, U2] = [(f2 = K2.declarations) != null ? f2 : "", K2.tokens || []], [B2, I2] = [(x3 = A2.declarations) != null ? x3 : "", A2.tokens || []], [H3, W2] = [(p = X.declarations) != null ? p : "", X.tokens || []], q2 = this.transformCSS(y2, `${G3}${B2}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y2, H3, "dark", "variable", r, i2, a2, n);
...
//# sourceMappingURL=chunk-7A5PVSBY.js.map
