...
// ../../node_modules/.pnpm/@primeuix+styles@2.0.3/node_modules/@primeuix/styles/dist/panelmenu/index.mjs
...
// ../../node_modules/.pnpm/primevue@4.5.4_vue@3.5.30_typescript@5.9.3_/node_modules/primevue/panelmenu/style/index.mjs
var classes = {
...
// ../../node_modules/.pnpm/primevue@4.5.4_vue@3.5.30_typescript@5.9.3_/node_modules/primevue/panelmenu/index.mjs
var script$3 = {
  name: "BasePanelMenu",
  "extends": script,
  props: {
...
var script$1 = {
  ...
  methods: {
    ...
    findLastItem: function findLastItem() {
      var _this4 = this;
      return V(this.visibleItems, function(processedItem) {
    ...
    findPrevItem: function findPrevItem(processedItem) {
      ...
      var matchedItem = index > 0 ? V(this.visibleItems.slice(0, index), function(pItem) {
    ...
    searchItems: function searchItems(event, _char) {
      ...
      if (s(this.focusedItem)) {
        ...
        matchedItem = l(matchedItem) ? this.visibleItems.slice(0, focusedItemIndex).find(function(processedItem) {
          return _this7.isItemMatched(processedItem);
        }) : matchedItem;
      } else {
