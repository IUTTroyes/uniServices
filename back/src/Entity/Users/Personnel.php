...
class Personnel implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Groups(['diplome:detail', 'maquette:detail', 'personnel:detail', 'personnel:light', 'previsionnel:read', 'previsionnel_enseignement:read', 'previsionnel_personnel:read', 'previsionnel_semestre:read', 'previsionnel_all_personnels:read', 'edt_event:read:agenda',"ticket:read","message:read"])]
