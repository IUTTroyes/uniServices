...
const panelMenuItems = [
  { label: 'Enquêtes', icon: 'pi pi-users',
    route: '/administration/qualite/enquetes' },
  { label: 'Qualité...', icon: 'pi pi-users', command: () => {router.push('/');} },
  { label: 'Qualité 2', icon: 'pi pi-users', command: () => {router.push('/');} },
];
</script>
